...
def parse_opt():
    ...
    # --------------------------- data path -------------------------#
    parser.add_argument('--data_path', default='../SGRAF/',
                        help='path to datasets')
    parser.add_argument('--data_name', default='f30k_precomp',
                        help='{coco,f30k}_precomp')
    parser.add_argument('--vocab_path', default='../SGRAF/vocab/',
                        help='Path to saved vocabulary json files.')
    parser.add_argument('--model_name', default='../SGRAF/runs/f30k_SGR/checkpoint',
                        help='Path to save the model.')
    parser.add_argument('--logger_name', default='../SGRAF/runs/f30k_SGR/log',
    ...
    parser.add_argument('--sim_dim', default=512, type=int,
